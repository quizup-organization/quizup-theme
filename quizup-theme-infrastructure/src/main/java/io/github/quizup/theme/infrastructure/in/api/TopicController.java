 ...
 * {@code POST /api/topics/search} avec filtres/sorts, et calcule ce dont il a besoin.
 */
@RestController
...
public class TopicController {
    ...
    /**
     * Catalogue des catégories de thèmes (code + libellé) — métadonnées d'énumération.
     */
    @GetMapping("/categories")
    public ResponseEntity<List<TopicCategoryResponse>> categories() {
        return ResponseEntity.ok(
                TopicResponseMapper.toCategoryResponse(Arrays.asList(TopicCategory.values()))
        );
    }
